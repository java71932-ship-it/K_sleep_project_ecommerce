        ...
        http
            .csrf(csrf -> csrf
                ...
                .ignoringRequestMatchers(
                    ...
                    "/insertproductdata", "/admin/products/delete/**", "/admin/products/update", 
                    "/admin/orders/update-status", "/placeOrder", "/cancelOrder", "/cnacelOrder", "/saveRating"
                )
            )
